...
<body class="relative min-h-screen selection:bg-blue-500/30 selection:text-blue-200">
    ...
    <nav id="navbar" class="fixed border border-transparent top-0 w-full z-50 transition-all duration-300 bg-transparent">
        ...
        <!-- Mobile Menu Overlay -->
        <div id="mobile-menu" class="fixed inset-0 bg-black/95 backdrop-blur-3xl z-[60] lg:hidden flex flex-col items-start justify-center px-12 gap-8 translate-x-full transition-transform duration-700 ease-[cubic-bezier(0.83,0,0.17,1)] overflow-hidden">
            <!-- Background Decorative Text -->
            <div class="absolute -bottom-20 -left-20 text-[30vw] font-black text-white/[0.02] select-none pointer-events-none tracking-tighter leading-none">
                MENU
            </div>
            
            <button id="mobile-menu-close" class="absolute top-8 right-8 w-14 h-14 rounded-full glass-panel flex items-center justify-center text-white border border-white/10 group active:scale-95 transition-transform">
                <i data-lucide="x" class="w-7 h-7 group-hover:rotate-90 transition-transform duration-500"></i>
            </button>
            
            <div class="flex flex-col items-start gap-12 text-5xl sm:text-6xl font-black tracking-tighter text-white">
                <div class="mobile-link-wrapper">
                    <a href="#overview" class="mobile-link block">Visão Geral</a>
                </div>
                <div class="mobile-link-wrapper">
                    <a href="#methods" class="mobile-link block">Métodos</a>
                </div>
                <div class="mobile-link-wrapper">
                    <a href="#compliance" class="mobile-link block">Segurança</a>
                </div>
                <div class="mobile-link-wrapper">
                    <a href="#business" class="mobile-link block">Como Funciona</a>
                </div>
            </div>
            
            <div class="mobile-menu-footer pt-12 border-t border-white/10 w-full flex flex-col gap-6">
                <p class="text-zinc-500 text-sm font-medium tracking-widest uppercase">Pronto para começar?</p>
                <a href="#" class="bg-blue-600 text-white px-8 py-5 rounded-2xl font-black text-lg flex items-center justify-between group overflow-hidden relative shadow-2xl">
                    <span class="relative z-10">Falar com Especialistas</span>
